...
WITH mapeo (dx_nombre, dx_uuid, lab_uuid) AS (
    ...
    SELECT 'ERC',                 '120574AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', '164364AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA' UNION ALL
    SELECT 'Neurocisticercosis',  '110508AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', '846AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'
)
SELECT
    m.dx_nombre,
